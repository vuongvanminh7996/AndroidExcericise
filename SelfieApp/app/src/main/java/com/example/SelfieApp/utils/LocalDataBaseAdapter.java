package com.example.SelfieApp.utils;
...
import com.example.SelfieApp.Fragments.LocalFragment;
import com.example.SelfieApp.ImageDetailActivity;
      ...
      //  myViewHolder.id.setText(singleRowArrayList.get(i).uid);
        myViewHolder.newsImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showImage(singleRowArrayList.get(i).image);
            }
        });
//        myViewHolder.
    ...
    public void showImage(String imageString)
    {
        Log.e("Error","Ayo");
        Intent intent = new Intent(context, ImageDetailActivity.class);
        intent.putExtra("BitmapImage", imageString);
